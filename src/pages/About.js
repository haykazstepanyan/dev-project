      ...
      <div className="about-us-info-section">
        <Grid container spacing={2}>
          <Grid item xs={11} lg={9} md={10} className="mx-auto">
            <img src={aboutMainImage} alt="about-us" className="w-100" />
          </Grid>
          ...
          <Grid container spacing={4}>
            <Grid item xs={12} lg={4}>
              <div className="text-center">
                ...
                <p className="about-info-title">Creative Design</p>
                <p className="about-info-text">
            ...
            <Grid item xs={12} lg={4}>
              <div className="text-center">
                ...
                <p className="about-info-title">100% Money Back Guarantee</p>
                <p className="about-info-text">
                  Erat metus sodales eget dolor consectetuer, porta ut purus at
                  et alias, nulla ornare velit amet
                </p>
            ...
            <Grid item xs={12} lg={4}>
              <div className="text-center">
                ...
                <p className="about-info-title">Online Support 24/7</p>
                <p className="about-info-text">
                  Erat metus sodales eget dolor consectetuer, porta ut purus at
                  et alias, nulla ornare velit amet
                </p>
        ...
        <Container maxWidth="lg" className="features-section-style">
          <Grid container spacing={4}>
            <Grid item xs={12} lg={4} md={4} sm={6}>
              <div className="text-center">
                <img alt="feature-img" src={featureIcon4} className="w-100" />
                <p className="about-info-title">What Do We Do?</p>
                <p className="about-info-text">
            ...
            <Grid item xs={12} lg={4} md={4} sm={6}>
              <div className="text-center">
                <img alt="feature-img" src={featureIcon5} className="w-100" />
            ...
            <Grid item xs={12} lg={4} md={4} sm={6}>
              <div className="text-center">
                <img alt="feature-img" src={featureIcon6} className="w-100" />
                <p className="about-info-title">History Of Us</p>
                <p className="about-info-text">
                  Sed ut perspiciatis unde omnis iste natus error sit voluptatem
                  accusantium doloremque laudantium, totam rem aperiam, eaque
                  ipsa quae ab illo inventore veritatis et quasi architecto
